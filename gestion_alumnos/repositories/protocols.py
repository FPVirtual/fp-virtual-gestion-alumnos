...
class AlumnoRepository(Protocol):
    """
    Protocolo para operaciones CRUD de alumnos.
    
    Abstrae el almacenamiento persistente de alumnos.
    """
    
    def obtener_todos(self) -> list[Alumno]:
        """Obtiene todos los alumnos almacenados."""
        ...
    
    def obtener_por_documento(self, documento: str) -> Alumno | None:
        """Busca un alumno por su documento."""
        ...
    ...
    def eliminar(self, documento: str) -> bool:
        """Elimina un alumno por documento."""
        ...
    
    def existe(self, documento: str) -> bool:
